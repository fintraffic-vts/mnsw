# Formalities markdown catalog

This markdown catalog mirrors the formalities viewer content in text-first format.

## Why this exists

- Offer downloadable source files in a simple, text-first structure
- Provide AI/LLM-friendly content shape
- Keep content close to accessibility goals with semantic markdown

## Contents

- [MIG root note: Data structures of formalities](./mig-data-structures.md)
- [MIG root note: Data content (MIG-P31 to MIG-P35)](./mig-data-content.md)
- [Formality pages](./formalities/index.md)
- Data artifacts:
  - [index.json](./data/index.md)
  - [config.json](./data/config.md)
  - [de-index.json](./data/de-index.md)
  - [rcg.json](./data/rcg.md)
  - [codelist.json](./data/codelist.md)
  - [codelist-to-formality.json](./data/codelist-to-formality.md)
  - [codelist-label-audit.json](./data/codelist-label-audit.md)
